...
class PlayerStatsEntryNumBreakdown(BaseModel):
    """
    PlayerStatsEntryNumBreakdown
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["max", "min", "median", "average"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlayerStatsEntryNumBreakdown from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlayerStatsEntryNumBreakdown from a dict"""
        if obj is None:
            return None
