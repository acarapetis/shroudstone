...
class PlayerStatsEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["date", "race", "matches", "wins", "losses", "ties", "win_rate", "mmr", "points", "match_length"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlayerStatsEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlayerStatsEntry from a dict"""
        if obj is None:
            return None
