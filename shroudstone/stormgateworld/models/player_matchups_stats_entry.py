...
class PlayerMatchupsStatsEntry(BaseModel):
    """
    PlayerMatchupsStatsEntry
    """ # noqa: E501
    match_length_range: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["match_length_range", "matches_count", "wins_count", "losses_count", "wins", "losses", "ties", "win_rate", "match_length"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlayerMatchupsStatsEntry from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if match_length_range (nullable) is None
        # and model_fields_set contains the field
        if self.match_length_range is None and "match_length_range" in self.model_fields_set:
            _dict['match_length_range'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlayerMatchupsStatsEntry from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "match_length_range": obj.get("match_length_range"),
