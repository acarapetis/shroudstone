...
class MatchParticipantPlayerResponse(BaseModel):
    """
    MatchParticipantPlayerResponse
    """ # noqa: E501
    player_id: StrictStr
    nickname: Optional[StrictStr] = None
    nickname_discriminator: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["player_id", "nickname", "nickname_discriminator"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchParticipantPlayerResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchParticipantPlayerResponse from a dict"""
        if obj is None:
            return None
