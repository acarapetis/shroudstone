...
class PlayerStartGame(_message.Message):
...
class ReplayChunk(_message.Message):
    ...
    class Wrapper(_message.Message):
        ...
        class ReplayContent(_message.Message):
            __slots__ = ["assign_player_slot", "change_slot", "map", "player", "player_left_game", "player_start_game", "set_variable", "start_game"]
            ...
            PLAYER_START_GAME_FIELD_NUMBER: _ClassVar[int]
