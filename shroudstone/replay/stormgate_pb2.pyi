...
class PlayerAlt(_message.Message):
    __slots__ = ["name"]
    class PlayerNameAlt(_message.Message):
        __slots__ = ["discriminator", "nickname"]
        DISCRIMINATOR_FIELD_NUMBER: _ClassVar[int]
        NICKNAME_FIELD_NUMBER: _ClassVar[int]
        discriminator: str
        ...
        def __init__(self, nickname: _Optional[str] = ..., discriminator: _Optional[str] = ...) -> None: ...
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: PlayerAlt.PlayerNameAlt
    def __init__(self, name: _Optional[_Union[PlayerAlt.PlayerNameAlt, _Mapping]] = ...) -> None: ...
...
class ReplayChunk(_message.Message):
    ...
    class Wrapper(_message.Message):
        ...
        class ReplayContent(_message.Message):
            __slots__ = ["assign_player_slot", "change_slot", "client_connected", "client_disconnected", "map_details", "player", "player_alt", "player_left_game", "set_variable", "start_game"]
            ...
            PLAYER_ALT_FIELD_NUMBER: _ClassVar[int]
            ...
            def __init__(self, map_details: _Optional[_Union[MapDetails, _Mapping]] = ..., client_connected: _Optional[_Union[ClientConnected, _Mapping]] = ..., player: _Optional[_Union[Player, _Mapping]] = ..., change_slot: _Optional[_Union[LobbyChangeSlot, _Mapping]] = ..., set_variable: _Optional[_Union[LobbySetVariable, _Mapping]] = ..., start_game: _Optional[_Union[StartGame, _Mapping]] = ..., player_left_game: _Optional[_Union[PlayerLeftGame, _Mapping]] = ..., client_disconnected: _Optional[_Union[ClientDisconnected, _Mapping]] = ..., assign_player_slot: _Optional[_Union[AssignPlayerSlot, _Mapping]] = ..., player_alt: _Optional[_Union[PlayerAlt, _Mapping]] = ...) -> None: ...
